...
import "dequal";
import { B as isFunction, i as isHTMLElement, o as omit, w as withGet, m as makeElement, a as executeCallbacks, b as addMeltEventListener, k as kbd, j as styleToString, u as useEscapeKeydown, e as effect, C as portalAttr, f as createElHelpers, t as noop, n as isBrowser } from "./create.js";
import { c as createDispatcher } from "./events.js";
import { s as sleep, g as generateIds, o as overridable, a as useModal, c as createFocusTrap, d as getPortalDestination, u as usePortal, r as removeScroll, i as fade, I as Icon } from "./Icon2.js";
    ...
    default: () => {
      return `${validate_component(Dialog_overlay, "Dialog.Overlay").$$render($$result, {}, {}, {})} ${validate_component(Dialog_content$1, "DialogPrimitive.Content").$$render(
        ...
        Object.assign(
          ...
          { transitionConfig },
          {
            class: cn("fixed left-[50%] top-[50%] z-50 grid translate-x-[-50%] translate-y-[-50%] gap-4 border bg-background p-6 shadow-lg rounded-lg max-h-[calc(100vh-2rem)] w-[calc(100vw-2rem)] overflow-y-auto max-w-[500px] sm:rounded-lg md:w-full", className)
          },
          $$restProps
        ),
        {},
