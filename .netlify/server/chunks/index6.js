...
import { c as create_ssr_component, s as spread, b as escape_object, f as add_attribute, e as escape, h as escape_attribute_value, v as validate_component } from "./ssr.js";
import { c as cn, d as flyAndScale } from "./utils.js";
import { s as sleep, w as wrapArray, u as usePortal, c as createFocusTrap, a as useModal, o as overridable, g as generateIds, l as last, b as back, f as forward, p as prev, n as next, d as getPortalDestination, e as generateId, r as removeScroll, t as toggle, I as Icon, h as scale } from "./Icon2.js";
import { dequal } from "dequal";
import { i as isHTMLElement, n as isBrowser, w as withGet, p as getElementByMeltId, q as isElement, r as isHTMLLabelElement, t as noop, u as useEscapeKeydown, a as executeCallbacks, o as omit, f as createElHelpers, v as isObject, x as stripValues, m as makeElement, d as disabledAttr, b as addMeltEventListener, k as kbd, y as isHTMLButtonElement, F as FIRST_LAST_KEYS, z as isElementDisabled, j as styleToString, e as effect, c as createHiddenInput, s as safeOnMount, A as isHTMLInputElement } from "./create.js";
import { c as createDispatcher } from "./events.js";
import { d as derived, w as writable, a as readonly } from "./index2.js";
import { t as toWritableStores, r as removeUndefined, g as getOptionUpdater } from "./separator.js";
import { t as tick } from "./scheduler.js";
import { flip, offset, shift, arrow, size, autoUpdate, computePosition } from "@floating-ui/dom";
import { c as createLabel } from "./input.js";
...
const Select_trigger = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Select_trigger$1, "SelectPrimitive.Trigger").$$render(
    ...
    Object.assign(
      {},
      {
        class: cn("flex h-10 w-full items-center justify-between rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:border-primary focus:border-2 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1", className)
      },
      $$restProps
    ),
    {},
