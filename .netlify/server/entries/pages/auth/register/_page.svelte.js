      ...
      default: () => {
        return `<form method="POST">${validate_component(Card_header, "Card.Header").$$render($$result, { class: "space-y-1" }, {}, {
          ...
          default: () => {
            ...
            })}</div> <div class="relative" data-svelte-h="svelte-hr5laz"><div class="absolute inset-0 flex items-center"><span class="w-full border-t"></span></div> <div class="relative flex justify-center text-xs uppercase"><span class="bg-card px-2 text-muted-foreground">Or continue with</span></div></div> ${each(fields, (field) => {
                  ...
                  return `${validate_component(Control, "Form.Control").$$render($$result, {}, {}, {
                    default: ({ attrs }) => {
                      return `${validate_component(Form_label, "Form.Label").$$render($$result, { class: "capitalize" }, {}, {
                        ...
                        $$result,
                        Object.assign({}, attrs, { type: field === "name" ? "text" : field }, $constraints[field], { value: $formData[field] }),
                        {
                          value: ($$value) => {
          ...
          default: () => {
            ...
            })} <p class="text-center text-sm">Already have an account? ${validate_component(Link, "Link").$$render($$result, { href: "/auth/login" }, {}, {
              default: () => {
                return `Log in`;
              }
            })}</p>`;
