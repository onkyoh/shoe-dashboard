<script lang="ts" context="module">
  ...
  <NoteContainer>
    <form method="POST" action="?/create" class="flex flex-col gap-2 h-full" use:enhance>
      <Form.Field {form} name="content" class="flex-grow space-y-0 flex flex-col gap-2">
        <Form.Control let:attrs>
          ...
          />
          <span class="ml-auto text-muted-foreground text-sm">{$formData.content?.length || "0"} / 1000</span>
        </Form.Control>
        <Form.FieldErrors />
      </Form.Field>
