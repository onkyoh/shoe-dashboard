<script lang="ts">
	...
	import BulletinForm from './(components)/BulletinForm.svelte';
	import Notes from './(components)/Notes.svelte';
	import BulletinSort from './(components)/BulletinSort.svelte';
	import BulletinContainer from './(components)/BulletinContainer.svelte';
