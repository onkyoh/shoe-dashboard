...
<Dialog.Root bind:open={deleteDialogOpen}>
    ...
    <Dialog.Content>
        <Dialog.Header>
            ...
            <Dialog.Description>
                This action cannot be undone. This will permanently remove you from this group and you will not be able to join unless you are invited again. Additionally you will lose your current role.
            </Dialog.Description>
        </Dialog.Header>
        <form action="?/leaveGroup" method="POST" use:enhance={leaveGroupAction}>
        <FormButton variant="destructive" isSubmitting={isLoading} disabled={isLoading}>Leave</FormButton>
        </form>
    </Dialog.Content>
</Dialog.Root>